import pygame
import sys
from utils.text_data import WIN_SCENE_TEXT
from scenes.scene import Scene
from utils.text import Text
from config.constants import EFFECTS_SOUND_VOLUME, FONT_PATH, SH_MID, SW_MID, WHITE_COLOR, WIN_SOUND
...
class WinScene(Scene):
    def __init__(self, game_scene):
        ...
        self.background_sound = pygame.mixer.Sound(WIN_SOUND)
        self.background_sound.set_volume(EFFECTS_SOUND_VOLUME)
        self.background_sound.play()

        self.text_list = self.get_text(WIN_SCENE_TEXT)
