import pygame
from config.constants import BLACK_COLOR, ENEMIES_SPRITES, SCREEN_HEIGHT, ANIMATION_COOLDOWN, ANIMATION_STEPS
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, pos, upgrade_type, groups, screen):
        ...
        self.screen = screen
        self.sprite_sheet = Spritesheet(ENEMIES_SPRITES, 0, 0, 128, 64, color_key=BLACK_COLOR)
    ...
    def populate_animation_list(self):
        y, width, height = 0, 16, 16

        if self.upgrade_type == "speed":
            y = 16
